...
struct xdpw_screencast_session_data {
	...
	// Désignation choisie par le joueur pour cette session (app_id/titre de
	// fenêtre, ou "screen" pour l'écran), lue dans le sélecteur interactif
	// (cyberrealm-capture-choice). NULL si aucune. Libéré dans session.c.
	char *capture_claim;
};
